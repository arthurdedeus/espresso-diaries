...
const posts = defineCollection({
  ...
  schema: z.object({
    ...
    coffee: z.object({ beans: z.string(), roaster: z.string().optional(), origin: z.string().optional(), dose: z.number(), yield: z.number(), extractionTime: z.number().optional(), grind: z.union([z.string(), z.number()]).optional() }),
